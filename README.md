...
class ConcreteProduct2(Product): def operation(self) -> str: return "{Result of the ConcreteProduct2}"
...
class View(object): def list_services(self, services): for svc in services: print(svc, " ")
